...
Expands to \prm{true} if the \prm{control sequence} is undefined, if it is a macro whose meaning is \cmd{relax}, or a parameterless macro whose replacement text is empty, and to \prm{false} otherwise.
